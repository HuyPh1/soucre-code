        ...
        if ($result->num_rows > 0) {
            ...
            if ($user_pass !== $re_user_pass) {
                ...
                if ($stmt->execute()) {
                    ...
                    header('Location: ./pages/signin_page.php?msg=success');
                    exit();
                } else {
                    alert_message('Failed to create new user!');
                    header('Location: ./pages/signup_page.php?msg=failed');
                    exit();
                }
                $stmt->close();
                $conn->close();
        ...
        <div class="p-6">
            ...
            <div class="m-4 p-3">
                ...
                <div class="text-center mt-[5vh]">
                    <p>Already have an account?<a href="./signin_page.php" class="ml-2 hover:text-sky-400 hover:underline">Sign In</a></p>
                </div>
            </div>
        </div>
    </div>
