        ...
        if ($user_email === 'admin@nei.com') {
            ...
            if ($result1->num_rows == 1) {
                ...
                if (password_verify($user_pass, $hash_pass)) {
                    alert_message('Login successful');
                    header("Location: ./pages/user_page.php?$row[user_id]");
                    exit();
                } else {
                    alert_message('Invalid email or password');
                }
        ...
        <div class="p-6">
            ...
            <div class="m-4 p-3">
                ...
                <div class="text-center mt-[5vh]">
                    <p>Don't have an account?<a href="./signup_page.php" class="ml-2 hover:text-sky-400 hover:underline">Sign Up</a></p>
                </div>
            </div>
        </div>
    </div>
